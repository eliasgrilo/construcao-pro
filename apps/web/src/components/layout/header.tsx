...
import { useEstoqueAlertas } from '@/hooks/use-supabase'
    ...
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b px-6 bg-background/80 backdrop-blur-md">
      ...
      <div className="flex items-center gap-1">
        ...
        <Button
          ...
          aria-label={
            alertCount > 0
              ? `${alertCount} alerta${alertCount !== 1 ? 's' : ''} de estoque baixo`
        ...
        <Button
          ...
          onClick={cycleTheme}
          title={`Tema: ${theme}`}
          aria-label={`Alternar tema. Atual: ${theme === 'light' ? 'Claro' : theme === 'dark' ? 'Escuro' : 'Sistema'}`}
        >

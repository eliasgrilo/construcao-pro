    ...
    <DialogPortal>
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-6">
            ...
            >
                ...
                {children}
                <DialogPrimitive.Close className="absolute right-4 top-4 sm:top-4 sm:right-4 flex h-8 w-8 items-center justify-center rounded-full bg-accent/80 text-muted-foreground transition-all hover:bg-accent hover:text-foreground focus:outline-none focus-visible:ring-2 focus-visible:ring-ring/40">
                    <X className="h-4 w-4" />
...
const DialogHeader = ({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) => (
    <div className={cn('flex flex-col space-y-1.5 text-center sm:text-left pr-8 mb-5', className)} {...props} />
)
...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Title ref={ref} className={cn('text-[19px] sm:text-[17px] font-semibold leading-tight tracking-tight', className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
    <DialogPrimitive.Description ref={ref} className={cn('text-[14px] sm:text-[13px] text-muted-foreground leading-relaxed', className)} {...props} />
))

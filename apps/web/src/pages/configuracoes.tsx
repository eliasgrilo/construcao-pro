            ...
            <div className="px-4 md:px-8 space-y-5 max-w-2xl">
                        ...
                        <div className="flex gap-2">
                            {themes.map((t) => (
                                ...
                                >
                                    ...
                                    <span className={cn('text-[12px] font-medium', theme === t.value ? 'text-primary' : 'text-muted-foreground')}>
                                        {t.label}
                                    </span>
                                </button>
                            ))}
                ...
                <Card>
                    ...
                    <CardContent className="space-y-1">
                        ...
                        <p className="text-[12px] text-muted-foreground">Sistema de Gestão de Inventário para Construção Civil</p>

...
import { useCreateFornecedor, useDeleteFornecedor, useFornecedores } from '@/hooks/use-supabase'
import { type CreateFornecedorInput, createFornecedorSchema } from '@/lib/schemas'
import { zodResolver } from '@hookform/resolvers/zod'
import type { ColumnDef } from '@tanstack/react-table'
import { Building, Mail, MapPin, Phone, Plus, Trash2 } from 'lucide-react'
      ...
      >
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Cadastre o fornecedor para vincular às entradas de estoque.
            </DialogDescription>
          </DialogHeader>
          <form

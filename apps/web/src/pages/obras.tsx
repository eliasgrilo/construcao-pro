        ...
        {[
          {
            ...
            color: '#AF52DE',
            value: vTerreno,
            valueColor: vTerreno > 0 ? '#AF52DE' : undefined,
          },
          {
            label: 'Burocracia',
            Icon: FileText,
            color: '#007AFF',
            value: vBurocracia,
            valueColor: vBurocracia > 0 ? '#007AFF' : undefined,
          },
          {
            label: 'Construção',
            Icon: Building2,
            color: '#FF9500',
            value: vConstrucao,
            valueColor: vConstrucao > 0 ? '#FF9500' : undefined,
          },
          ...
          <div className="flex items-center gap-1.5">
            <span
              className={cn(
                ...
                (obra.percentualOrcamento ?? 0) > 90
                  ? 'text-destructive'
                  : (obra.percentualOrcamento ?? 0) > 70
                    ? 'text-warning'
                    : 'text-success',
              )}
            >
            ...
            <span className="text-[13px] text-muted-foreground">
              {formatCurrency(obra.custoTotal)}
            </span>
          </div>
        )}
        <Badge variant={st.variant} className="ml-auto">
          {st.label}
        </Badge>
      </div>
    </motion.div>
...
export function ObrasPage() {
  ...
  const [filterStatus, setFilterStatus] = useState<
    'ALL' | 'ATIVA' | 'PAUSADA' | 'FINALIZADA' | 'VENDIDO' | 'TERRENO'
  >('ALL')
          ...
          <div className="text-center py-20">
            ...
            {filterStatus !== 'ALL' || search ? (
              ...
              <>
                ...
                <p className="text-[15px] text-muted-foreground/70 mt-1">
        ...
        <DialogContent>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              />
              {errors.endereco && (
                <p className="text-[13px] text-destructive mt-1">{errors.endereco.message}</p>
              )}
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                ...
                />
                {errors.orcamento && (
                  <p className="text-[13px] text-destructive mt-1">{errors.orcamento.message}</p>
                )}
              </div>
            </div>
            <div className="space-y-2">
              ...
              />
              {errors.valorTerreno && (
                <p className="text-[13px] text-destructive mt-1">{errors.valorTerreno.message}</p>
              )}
            </div>
            <DialogFooter>
              <Button

...
const supabaseKey =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZqaWFiZmZxcXd4dXFyeWJ2Z2F0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE3ODEyMzgsImV4cCI6MjA4NzM1NzIzOH0.sOk8_0PsIUl36wnntvvGYoOPy8WugIPOV9drV0HfIb4'
...
async function test() {
  ...
  const params = {
    p_material_id,
    p_quantidade: 1,
    p_preco_unitario: mats[0].preco_unitario,
    p_almoxarifado_id,
  }
